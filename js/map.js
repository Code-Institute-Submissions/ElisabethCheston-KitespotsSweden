...
/*
        ...
        var ffilter = ["allKitespots",["==", "windDirection", "S"],];

        var filtered_geojson = geojson_filter(kitespots , ffilter);
        /*
        // - Filter function for kitespots - //
        var filterKitespots = L.geoJson(null, {
        onEachFeature: function(feature, layer) {
        
            var allSpotsCluster = feature.properties();
                if      ( windDirection == 'S' ) layer.addTo(kitespotS);
                else if ( windDirection == 'W' ) layer.addTo(kitespotW);
                else if ( windDirection == 'N' ) layer.addTo(kitespotN);
                else if ( windDirection == 'E' ) layer.addTo(kitespotE);
                else 
                layer.addTo(statusUnsure);
        }
    });        
*/
        // - Control layers - //
