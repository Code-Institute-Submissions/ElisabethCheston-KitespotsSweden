// - Description: https://opendata.smhi.se/apidocs/IBWwarnings/objects.html - //

// - Reference: https://opendata.smhi.se/apidocs/js/smhi-opendata-IBWwarnings.js - //

/*
(function (smhi, $, undefined) {
     // - The API end point. This is the only hardcoded url. All other urls are returned in responses. - //
  ...
  smhi.activArea = [];
    ...
    smhi.getWarningViews = function (callback) {
        var endPoint = 'res/demo.json'; //var endPoint = smhi.endPoint + '/warning/';
    ...
    smhi.getDistrictViews = function (callback) {
        var endPoint = 'res/district.json'; //var endPoint = smhi.endPoint + '/metadata/area/';
...
$(document).ready(function () {
    ...
    var southWest = L.latLng(52.500440,2.250475); // create leaflet map and disable interaction
...
function getDistrictViews() {
    ...
    smhi.getDistrictViews(function (NewDistrictViews) {district.area // Get the district views
